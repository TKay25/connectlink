    ...
    with get_db() as (cursor, connection):
        try:
            ...
            project = {
                ...
                'installment1duedate': row[27].strftime("%-d %B %Y") if len(row) > 27 else None,
                'installment1date': row[28].strftime("%-d %B %Y") if len(row) > 28 else None,
                'installment2amount': row[29] if len(row) > 29 else None,
                'installment2duedate': row[30].strftime("%-d %B %Y") if len(row) > 30 else None,
                'installment2date': row[31].strftime("%-d %B %Y") if len(row) > 31 else None,
                'installment3amount': row[32] if len(row) > 32 else None,
                'installment3duedate': row[33].strftime("%-d %B %Y") if len(row) > 33 else None,
                'installment3date': row[34].strftime("%-d %B %Y") if len(row) > 34 else None,
                'installment4amount': row[35] if len(row) > 35 else None,
                'installment4duedate': row[36].strftime("%-d %B %Y") if len(row) > 36 else None,
                'installment4date': row[37].strftime("%-d %B %Y") if len(row) > 37 else None,
                'installment5amount': row[38] if len(row) > 38 else None,
                'installment5duedate': row[39].strftime("%-d %B %Y") if len(row) > 39 else None,
                'installment5date': row[40].strftime("%-d %B %Y") if len(row) > 40 else None,
                'installment6amount': row[41] if len(row) > 41 else None,
                'installment6duedate': row[42].strftime("%-d %B %Y") if len(row) > 42 else None,
                'installment6date': row[43].strftime("%-d %B %Y") if len(row) > 43 else None,
